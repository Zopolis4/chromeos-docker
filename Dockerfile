...
PATH=/usr/local/bin:/usr/local/sbin:$PATH   CREW_CACHE_DIR=/input/pkg_cache   CREW_CACHE_ENABLED=1   CREW_FORCE_INSTALL=1   CREW_KERNEL_VERSION=$CREW_KERNEL_VERSION   /bin/bash /home/chronos/user/install.sh
